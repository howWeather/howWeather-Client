...
class _LocationSelectionPageState extends ConsumerState<LocationSelectionPage> {
  ...
  final currentUserLocation = null; // ref.watch로 현재 설정된 위치 가져오기
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Medium_16px(
                        text: "현재 설정: $currentUserLocation",
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isCurrentLocation = address == currentUserLocation;
